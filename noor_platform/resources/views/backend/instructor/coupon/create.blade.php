            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">إضافة قسيمة خصم</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card col-md-8">
            <div class="card-body p-4">
                ...
                <div style="display: flex; align-items:center; justify-content:space-between">
                    ...
                    <a href="{{ route('instructor.coupon.index') }}" class="btn btn-primary">عودة</a>
                </div>
                ...
                <form class="row g-3" method="post" action="{{ route('instructor.coupon.store') }}">
                    ...
                    <div class="col-md-6">
                        <label for="coupon_discount" class="form-label">نسبة الخصم</label>
                        <input type="text" class="form-control" name="coupon_discount" id="coupon_discount"
                            value="{{ old('coupon_discount') }}" placeholder="أدخل نسبة الخصم">
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="d-md-flex d-grid align-items-center gap-3">
                            <button type="submit" class="btn btn-primary px-4 w-100">حفظ</button>
                        </div>
                    </div>
                </form>
